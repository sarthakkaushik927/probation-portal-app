          ...
          <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', padding: 24, paddingBottom: 100 }}>
            <View className="items-center mb-8 mt-10">
              ...
              <View className="mt-2 items-center">
                <Text className="text-2xl font-bold font-sans text-zinc-900 dark:text-white mb-1 tracking-tight">Create Account</Text>
                <Text className="text-zinc-500 dark:text-zinc-400 font-sans text-sm">Join NextGen</Text>
              </View>
            </View>
